            ...
            <form name="Event" id="Event" method="post" enctype="multipart/form-data"
                ...
                <div class="card">
                    <div class="card-header border-bottom-0">
                        ...
                        <h1 class="card-title text-center"><label>Edit Vehilcle Details </label></h1>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="transmission"name="transmission" class="form-control"
                                    ...
                                    <option value="Semi-Auto" @if (old('transmission') == 'Semi-Auto' || $EvetList->transmission == 'Semi-Auto') selected @endif>Semi-Auto
                                    </option>
                                </select>
                                @error('transmission')
                                    <span class="text-danger">{{ $message }}</span>

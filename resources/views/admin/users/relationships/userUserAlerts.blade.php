<div class="m-3">
    @can('user_alert_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-outline-success" href="{{ route('admin.user-alerts.create') }}">
                    ...
                    <tbody>
                        @foreach($userAlerts as $key => $userAlert)
                            <tr data-entry-id="{{ $userAlert->id }}">
                                ...
                                <td>
                                    @can('user_alert_show')
                                        <a class="btn btn-xs btn-outline-primary" href="{{ route('admin.user-alerts.show', $userAlert->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

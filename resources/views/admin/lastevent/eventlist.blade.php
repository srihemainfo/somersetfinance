                ...
                <div class="main-header-left ">
                    ...
                    <div class="responsive-logo">
                        <a href="index.html" class="header-logo"><img
                                src="{{ asset('theme/assets/img/brand/logo.png') }}" class="logo-11"></a>
                        <a href="index.html" class="header-logo"><img
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Sell Vechile </a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sell Vechile Details</li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <table class="table border-top-0 table-bordered text-nowrap border-bottom"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-10p border-bottom-0 disableFilterBy"
                                        ...
                                        <tbody>
                                            @foreach ($LatestEvent as $event)
                                                <tr>
                                                    ...
                                                    <td>{{ $event->title }} {{ $event->brand }} {{ $event->model }}
                                                        ({{ $event->year }})</td>
                                                    <!--<td>{!! $event->content !!}</td>-->
                                                    ...
                                                    <td>
                                                        <form action="{{ route('eventlist.destroy', $event->id) }}"
                                                            method="Post">
                                                            <a class="btn btn-info"
                                                                href="{{ route('eventlist.edit', $event->id) }}">Edit</a>
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                            ...
                                                            <a class="btn btn-info" href="#"
                                                                onclick="openImageUploadPopup('{{ $event->event_slug }}'); return false;">Upload
                                                                Image</a>
                                                        </form>
                                                    </td>
                                                </tr>
                ...
                <div class="modal-dialog" role="document" style="width: 75%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            <form method="post" id="service_content_image_upload_form"
                                ...
                                <div class="md-form mb-5">
                                    ...
                                    <p id="service_content_image_error"
                            ...
                            <button class="btn btn-primary float-end"
                                onclick="UploadServiceContentImages()">Upload</button>
...
{{--  https://www.spinny.com/used-cars-from-2022-over-250000-rs-under-4-lakh-rs-in-chennai/s/?utm_medium=gads_c_search&utm_source=SPD-Search-Top8-National-Sale-PM&utm_content=679133798611&utm_term=p_car+sale+site&partner_id=CjwKCAjwmYCzBhA6EiwAxFwfgJ6BxGXkggH9umlZzGc_1IAl_qBELguromSFkRuTHYjqQrB6gba0sBoCXKwQAvD_BwE&source=googleads&sub_source=SPD-Search-Top8-National-Sale-PM&gclid=CjwKCAjwmYCzBhA6EiwAxFwfgJ6BxGXkggH9umlZzGc_1IAl_qBELguromSFkRuTHYjqQrB6gba0sBoCXKwQAvD_BwE
    --}}

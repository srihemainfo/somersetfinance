...
@can('permission_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-outline-success" href="{{ route('admin.permissions.create') }}">
                ...
                <tbody>
                    @foreach($permissions as $key => $permission)
                        <tr data-entry-id="{{ $permission->id }}">
                            ...
                            <td>
                                @can('permission_show')
                                    <a class="newViewBtn" href="{{ route('admin.permissions.show', $permission->id) }}" title="View">
                                    <i class="fa-fw nav-icon far fa-eye"></i>
                                    </a>
                                @endcan

                                @can('permission_edit')
                                    <a class="newEditBtn" href="{{ route('admin.permissions.edit', $permission->id) }}" title="Edit">

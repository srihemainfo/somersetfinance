      ...
      <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-12 row mb-2">
                ...
                <div class="col-sm-3">
                    <label for="partner_filter" class="col-form-label">Partner</label>
                ...
                <div class="col-sm-3" style="display:flex;align-items:end;gap:20px;padding-top: 1rem;">
    ...
    <script>
      ...
      $(document).ready(function() {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        Swal.fire({
                            ...
                            if (frameby.value) {
                                ...
                                $.ajax({
                                        method: 'POST',
                                        url: "{{ route('admin.application-stage.massDestroy') }}",
                                         headers: {
            ...
            $('#reset').on('click', function(e) {
                $('#Loan_type_filter').val('').select2();
                $('#customer_filter').val('').select2();
                $('#partner_filter').val('').select2();
                $('#status_filter').val('').select2();
                $('#case_date').val('');

<script>
            ...
            // });
                    ...
                    if(selectedRole === 'broker'){
                        ...
                        if($('#application_made').val() != 'Personal Name'){
                            ...
                            var fieldArray = ['company_name', 'company_no', 'loan_amount', 'term_year', 'term_month','company_address_1', 'company_security_address_line1','company_client_propertity_value'];
                            fieldArray.forEach(function(fieldId, index) {
                                ...
                                var fieldArray = ['purpose_loan', 'application_made', 'loan_amount', 'term_year', 'term_month','client_propertity_value'];
                                fieldArray.forEach(function(fieldId,index) {
                                    var field = $('#' + fieldId);
                                    if (!field.val() || field.val() === 'Select') {
                                        field.addClass('error');
                    ...
                    var fieldArray = ['loan_amount', 'term_year', 'term_month'];
    ...
    //         $('#mortage_question_no_result,#mortage_question_yes_result,#broker_form').hide();
    ...
    $(document).on('change', '#loan_category', function() {
        ...
        if (selectedRole === 'broker') {
             ...
             if(selectedStatus == ''){
                 $('#broker_form').show();
                 $('#mortage_question_no_result,#introducer_form,#introducer_company_form,#mortage_question_yes_result,').hide();
    ...
    $(document).on('change', "#application_made", function(){
     ...
     $(document).on('change', '#case_status', function(e) {
                e.preventDefault(); 
                var id_ = "{{ ($isEditable && $data->id) ? ( $data->id ?? '') : ''}} ";
                var status  = $(this).val();
                if(id_ && status ){
                Swal.fire({
                    title: "Are You Sure?",

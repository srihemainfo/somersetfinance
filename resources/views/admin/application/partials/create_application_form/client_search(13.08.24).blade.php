...
<div class="card">
    ...
    <div class="card-body">
            <div class="row" {{ $isEditable ?? 'hidden' }}>
                <div class="col-sm-4">
                    <label for="search_clients">Search Customers <span class="required">*</span></label>
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-success m-auto" title="Add Customer" id="addCustomer"><i
            ...
            <div id="coapplicant_content_div">
                ...
                <div class="row coapplicant-fields my-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control co_applicants_phone" oninput="validateInput(this)" name="co_applicants_phone[]" placeholder="Enter Co-applicant Phone" Phone" value="{{ $coapplicant->phone ?? '' }}" >
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row coapplicant-fields my-3">
                    ...
                    <div class="col-sm-3">
                        <label for="co_applicants" class="form-label">Co-Applicant phone</label>
                        <input type="text" class="form-control co_applicants_phone" name="co_applicants_phone[]" oninput="validateInput(this)" placeholder="Enter Co-applicant Phone">
                    </div>
                    <div class="col-sm-3">
                        <label for="co_applicants" class="form-label">Co-Applicant Address</label>
    ...
    <div class="card-body">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Customer Reference</label>
                        <input type="text" class="form-control" value="Reference">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
...
<div class="card" id="introducer_company_form"  style="{{ ($isEditable && $data->application_made != 'Personal Name' && $data->mortgage_status == 'no'  ) ?  'display:block' : 'display:none' }}">
            <div class="card-header">
                Please Provide Company and Customer Details
            </div>
            <div class="card-body">
                <!--  -->

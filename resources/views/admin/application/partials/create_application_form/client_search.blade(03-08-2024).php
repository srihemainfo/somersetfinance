            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" {{ $isEditable && $data->live_or_intent_property == 'no' ?'checked' : '' }}  type="radio" name="live_or_intent_property" id="live_or_intent_property" value="no">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name='client_propertity_value' title='Enter number only' id="client_propertity_value" value="{{$isEditable && $data->client_propertity_value ?? ''}}"    class="form-control" placeholder="Enter Property Value" oninput="validateInput(this)">
                     <span class="error-message">This field is required.</span>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name='client_extra_comment' id="client_extra_comment" value="{{$isEditable && $data->client_extra_comment ?? ''}}"   class="form-control">
...
<div class="col-sm-12 main-card mb-3 card" id='document_container' style='display:none'>
    <div class="card-body">
        ...
        <div class="card-body">
            ...
            <div class="card-header">
                <h4 class="card-title">Additional Document</h4>
            </div>
            ...
            <div class="row mb-3" id="points_values">
              ...
              <div class="card-header">
                <h4 class="card-title">Additional Form Document</h4>
            </div>

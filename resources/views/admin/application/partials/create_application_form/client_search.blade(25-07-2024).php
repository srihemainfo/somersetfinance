            ...
            <div id="coapplicant_content_div">
                ...
                <div class="row coapplicant-fields my-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <textarea class="form-control co_applicants_address" name="co_applicants_address[]" id="" cols="10" rows="5" placeholder="Enter Co-applicant Address">
                            {{ $coapplicant->address ?? '' }}
                        </textarea>
                         </div>
                         @if(!$i)
                ...
                <div class="row coapplicant-fields my-3">
                    ...
                    <div class="col-sm-4">
                        <label for="co_applicants" class="form-label">Co-Applicant Address</label>
                        <textarea class="form-control co_applicants_address" name="co_applicants_address[]" id="" cols="10" rows="5" placeholder="Enter Co-applicant Address"></textarea>
                         </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name='loan_amount' class="form-control"  value={{ $isEditable && $data->loan_amount ? $data->loan_amount : '' }} >
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name='term' class="form-control" value={{ $isEditable && $data->term ? $data->term : '' }}  >
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Rate%</label>
                        <input type="text" name='rate' class="form-control" value={{ $isEditable && $data->rate ? $data->rate : '' }} >
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Proc Fee</label>
                        <input type="text" name='proc_fee' class="form-control" value={{ $isEditable && $data->proc_fee ? $data->proc_fee : '' }} >
                    </div>
                </div>

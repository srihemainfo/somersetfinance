        ...
        $(inputSelector).on('change', function(event) {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                if (file && (file.type.startsWith('image/') || 
                     ...
                     file.type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')) {    let formData = new FormData();
...
$(document).on('click', '[id^=upload_change_], [id^=upload1_change_], [id^=upload2_change_],[id^=upload3_change_]', function(event) {
    ...
    if (file) {
        // Check if file is an image, PDF, or Word document
        const allowedTypes = [
        ...
        if (allowedTypes.includes(file.type)) {
            ...
            if (file.size <= minSizeBytes) {
                ...
                Swal.fire('', 'File must be at maximum 10 MB', 'error');
            }
        } else {
            Swal.fire('', 'Only image, PDF, or Word files are allowed', 'error');
        }
    }
});

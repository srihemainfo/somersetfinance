                                    ...
                                    <table class="table table-borderless mb-0 profile_details">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted">{{ $data->customerdetail->address ?? 'N/a' }}
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <table class="table table-bordered">
                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" title="Upload Document" class="btn_borderless upload_document_modal" data-toggle="modal"
                                                     ...
                                                     @if($roleTitle ==1)
                                                    <td class="text-center">
                                                        <button type="button" title="Deleted Document" class="btn_borderless upload_document_delete" data-toggle="modal"
                                                            data-application-id="{{ $data->id }}"
                                                            data-document-id="{{ $document->id }}"
                                                        >
                                    ...
                                    @endphp
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" title="Upload Document" class="btn_borderless upload_additional_document_modal" data-toggle="modal"
                                                    data-target="#upload_document_modal1"
                                                        data-application-id="{{ $data->id }}"
                                                        data-document-id="{{ $document->id }}"
                                                    >
                                                 ...
                                                 @if($roleTitle ==1)
                                                 <td class="text-center">
                                                        <button type="button" title="Deleted Document" class="btn_borderless upload_additional_document_delete" data-toggle="modal"
                                                            data-application-id="{{ $data->id }}"
                                                            data-document-id="{{ $document->id }}"
                                                        >
                                                       <i class=" fa-fw nav-icon fas fa-trash"></i>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                ...
                                                @endphp
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" title="Upload Document" class="btn_borderless upload_form_modal"
                                                            data-toggle="modal"
                                                         ...
                                                         @if($roleTitle ==1)
                                                         <td class="text-center">
                                                        <button type="button" title="Deleted Document" class="btn_borderless upload_form_delete " data-toggle="modal"
                                                            data-application-id="{{ $data->id }}"
                                                            data-document-id="{{ $document->id }}"
                                                        >
                                                       <i class=" fa-fw nav-icon fas fa-trash"></i>
                                            ...
                                            @endif
                                             ...
                                             @if (isset($data->additionFormUploads))
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $si = 1;
                                    @endphp
                                    @if((isset($data->additionalDocument2) && !empty($data->additionalDocument2) ))

                                    {{-- @php
dd($data->additionalDocument2);
                                        @endphp
                                    @endphp --}}
                                    @foreach($data->additionalDocument2 as $document)
                                                ...
                                                <td class="text-center">
                                                    @if($documentImagesForDocument)
                                                            @if(  $reuploadCount || $rejectedCount)
                                                                ...
                                                                @if($roleTitle == 1)
                                                                    @if($reuploadCount)
                                                                        <img src="{{ asset('formupload/stage_reupload.png') }}" class="document_status_img">
                                                                    @elseif($rejectedCount)
                                                            ...
                                                            @elseif($acceptedCount)
                                                                <img src="{{ asset('formupload/file_success.png') }}" class="document_status_img">
                                                            @else
                                                                <img src="{{ asset('formupload/file_pending.png') }}" class="document_status_img">
                                                            @endif
                                                        @else
                                                            <img src="{{ asset('formupload/file_pending.png') }}" class="document_status_img">
                                                        @endif
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $(document).on('click', '.remark_submit2', function(e) {
        //     e.preventDefault();
        //     var applicationId =  window['applicationId2'];
        //     var documentId = window['documentId2'] ;
        //     var imageId = window['imageId'] ;
        //     var radio = $('input[name="radio"]:checked').val();
        //     var admin_remark = $('input[name="admin_remark"]').val() ;
        ...
        //     loader.show()
        //         $.ajax({
        //             url: "{{ route('admin.document.remarkUpdatedadmin2') }}",
        //             method: 'POST',
        //             headers: {
        //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //             },
        ...
        // $(document).on('click', '.remark_submit1', function(e) {
        //     e.preventDefault();
        //     loader.show()
        //     var applicationId =  window['applicationId1'];
        //     var documentId = window['documentId1'] ;
        ...
        //     $('.secondLoader').show()
        //         $.ajax({
        //             url: "{{ route('admin.document.formremarkUpdatedadmin') }}",
        //             method: 'POST',
        //             headers: {
        //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //             },
...
handleRemarkSubmit('.remark_submit1', "{{ route('admin.document.formremarkUpdatedadmin') }}", 'applicationId1', 'documentId1');
        ...
        // $(document).on('click', '#submit_button1', function(e) {
        //     e.preventDefault();
        //     var applicationId =  window['applicationId1'];
        //     var documentId = window['documentId1'] ;
        //     var selectedFiles1 = selectedFiles ;
        //     let inputNames = [];
        //     $('#uploaded_images_container1 form').each(function() {
        //         inputNames.push($(this).serialize());
        //     });
        ...
        //     loader.show()
        //         $.ajax({
        //             url: "{{ route('admin.document.formremarkUpdated') }}",
        //             method: 'POST',
        //             headers: {
        //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //             },
        ...
        // $(document).on('click', '#submit_button2', function(e) {
        //     e.preventDefault();
        //     var applicationId =  window['applicationId2'];
        //     var documentId = window['documentId2'] ;
        //     var selectedFiles1 = selectedFiles ;
        //     let inputNames = [];
        //     $('#uploaded_images_container2 form').each(function() {
        //         inputNames.push($(this).serialize());
        //     });
        ...
        //     loader.show()
        //         $.ajax({
        //             url: "{{ route('admin.document.additionalremarkUpdated') }}",
        //             method: 'POST',
        //             headers: {
        //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //             },
...
//                                     const currentcontainer = $('#uploaded_images_container');
//                                     let currentImageCount = currentcontainer.children().length;
...
//         //22-07-2024
// $(document).on('click', '.upload_additional_document_modal', function() {
...
//         window['applicationId2'] = applicationId ;
//         window['documentId2'] = documentId ;
//         // var files = $('#file_upload').val();
//         // var filesInput = $('#file_upload')[0];
//         // var files = filesInput.files;
...
//                     // formData.append('files', files);
//                     $('.secondLoader').show()
//                     const container = $('#uploaded_images_container2');
//                         container.empty();
//                     $.ajax({
//                         url: "{{ route('admin.document.upload_addition_image_get') }}",
//                         method: 'POST',
//                         headers: {
//                             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                         },
...
//                                 $('#modal_application_id2').val(applicationId);
//                                 $('#modal_document_id2').val(documentId);
//                                 $('#additional_modal').modal('show') ;

//                                 container.html(response.data) ;

//                                 const currentcontainer = $('#uploaded_images_container2');
//                                 let currentImageCount = currentcontainer.children().length;
...
// $(document).on('click', '.upload_form_modal', function() {
...
//                 $('.secondLoader').show()
//                 $.ajax({
//                     url: "{{ route('admin.document.upload_image_get1') }}",
//                     method: 'POST',
//                     headers: {
//                         'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                     },
...
//                             const currentcontainer = $('#uploaded_images_container1');

//                             $('#modal_application_id1').val(applicationId);
//                             $('#modal_document_id1').val(documentId);
//                             $('#upload_document_modal_1').modal('show') ;

//                             currentcontainer.html(response.data) ;
...
//             let formData = new FormData(); // Create new FormData for each file
...
//             // Using closure to capture variables
//             (function(fileData, count) {
//                 $.ajax({
//                     url: "{{ route('admin.document.upload_image_get') }}",
//                     method: 'POST',
//                     headers: {
//                         'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                     },
//                     data: fileData, // Use the captured FormData
//                     processData: false,
//                     contentType: false,
//                     success: function(response) {
//                         if (response.data) {
...
//                     }
//                 });
//             })(formData, currentImageCount);

//             currentImageCount++; // Increment outside of closure
//             }
//         }
...
//     const files = event.target.files;
//     const container = $('#uploaded_images_container1');
//     let currentImageCount = uploadimage;
...
//             (function(fileData, count) {
//                 $.ajax({
//                     url: "{{ route('admin.document.upload_form_image_get') }}",
//                     method: 'POST',
//                     headers: {
//                         'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                     },
...
// $('#file_upload_two').on('change', function(event) {
//     const files = event.target.files;
//     const container = $('#uploaded_images_container2');
//     let currentImageCount = uploadimage;
//     var applicationId = window['applicationId2'];
...
//                 // Perform AJAX request for each file
//                 $.ajax({
//                     url: "{{ route('admin.document.upload_additioanl_image_get') }}",
//                     method: 'POST',
//                     headers: {
//                         'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                     },
...
//                 // Increment the image count for the next file
//                 currentImageCount++;
//             })(file, i);
//         }
//     }
...
handleFileUpload('#file_upload_two', '#uploaded_images_container2', "{{ route('admin.document.upload_additioanl_image_get') }}", 'applicationId2', 'documentId2');
        ...
        //     const index = fileId.split('_').pop();
        ...
        //     $.ajax({
        //         url: "{{ route('admin.document.upload_preview') }}",
        //         method: 'POST',
        //         headers: {
        //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //         },
        ...
        //  // Fullscreen Preview
        //  $(document).on('click', '[id^=upload1_preview_]', function(event) {
        //     event.preventDefault();
        //     const fileId = $(this).data('file-id');
        //     const fileType = $(this).data('file-type');
        //     const remark = $(this).data('remark-type');
        ...
        //     const appId = $(this).data('app-id');
        //     const documentId = $(this).data('document-id');
        //     const modalBody = $('#fullscreenPreviewModal1 .modal-body');
        //     modalBody.empty(); // Clear previous content
        //     window['imageId'] = imageId ;
        ...
        //     $.ajax({
        //         url: "{{ route('admin.document.form_upload_preview') }}",
        //         method: 'POST',
        //         headers: {
        //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //         },
        ...
        //                 modalBody.html(response.data);
        //                 $('#fullscreenPreviewModal1').modal('show');
        ...
        // //22-07-2024
        //   // Fullscreen Preview
        //   $(document).on('click', '[id^=upload2_preview_]', function(event) {
        //     event.preventDefault();
        //     const fileId = $(this).data('file-id');
        //     const fileType = $(this).data('file-type');
        //     const remark = $(this).data('remark-type');
        ...
        //     const appId = $(this).data('app-id');
        //     const documentId = $(this).data('document-id');
        //     const modalBody = $('#fullscreenPreviewModal_2 .modal-body');
        //     modalBody.empty(); // Clear previous content
        //     window['imageId'] = imageId ;
        ...
        //     $.ajax({
        //         url: "{{ route('admin.document.addtioanl_upload_preview') }}",
        //         method: 'POST',
        //         headers: {
        //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        //         },
        ...
        //                 modalBody.html(response.data);
        //                 $('#fullscreenPreviewModal_2').modal('show');
...
//     $(document).on('click', '[id^=upload1_change_]', function(event) {
//         event.preventDefault();
//         const fileId = $(this).data('file-id');
//         const imageId = $(this).data('image-id');
//         const input = $('<input>', { type: 'file', accept: 'image/*,application/pdf' });
...
//     $(document).on('click', '[id^=upload2_change_]', function(event) {
//         event.preventDefault();
//         const fileId = $(this).data('file-id');
//         const imageId = $(this).data('image-id');
//         const input = $('<input>', { type: 'file', accept: 'image/*,application/pdf' });
...
$(document).on('click', '[id^=upload_change_], [id^=upload1_change_], [id^=upload2_change_]', function(event) {
    event.preventDefault();
    ...
    if (buttonId.startsWith('upload1_change_')) {
        ...
        ajaxUrl = "{{ route('admin.document.upload_additioanl_image_get') }}";
        number= 2;
    } else {
        applicationId = window['applicationId1'];
        documentId = window['documentId1'];
...
$(document).on('click', '[id^=upload1_delete_], [id^=upload2_delete_], [id^=upload_delete_]', function(event) {
    event.preventDefault();
...
// $(document).on('click', '[id^=upload1_delete_]', function(event) {
//         event.preventDefault();
...
//         Swal.fire({
//                     title: "Are You Sure?",
//                     text: "Do You  Want Delete the Image?",
//                     icon: "warning",
//                     showCancelButton: true,
//                     confirmButtonText: "Yes",
//                     cancelButtonText: "No",
...
//                         $.ajax({
//                             url: "{{ route('admin.document.upload_image_get_delete1') }}",
//                             method: 'POST',
//                             headers: {
//                                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                             },
...
// $(document).on('click', '[id^=upload2_delete_]', function(event) {
//         event.preventDefault();
...
//                         $.ajax({
//                             url: "{{ route('admin.document.upload_image_get_delete2') }}",
//                             method: 'POST',
//                             headers: {
//                                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//                             },
...
//                     $(`#${file_id}`).closest('.all_file_data').remove();
...
//                 // Adjust the remaining elements to show properly
//                 // adjustDisplay();
//             } else {
//                 Swal.fire('', response.message, 'error');
//             }
...
// $('#delete_selected1').on('click', function(event) {
//             event.preventDefault();

//             var $checkedBoxes = $('.form_delete-checkbox:checked');
...
//     $.ajax({
//         url: "{{ route('admin.document.upload_form_image_get_deletes') }}",
//         method: 'POST',
//         headers: {
//             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
//         },
...
// $('#delete_selected2').on('click', function(event) {
//             event.preventDefault();

//             var $checkedBoxes = $('.addition_delete_checkbox:checked');
...
// handleDeleteClick('#delete_selected2', '.addition_delete_checkbox', "{{ route('admin.document.upload_form_image_get_deletes') }}", window['applicationId2'], window['documentId2']);
...
// // Show/hide delete selected button based on checkbox state
// $(document).on('change', '.addition_delete_checkbox', function() {
//     if ($('.addition_delete_checkbox:checked').length > 0) {
//         $('#delete_selected2').show();
//     } else {
...
//   // Show/hide delete selected button based on checkbox state
//   $(document).on('change', '.form_delete-checkbox', function() {
//     if ($('.form_delete-checkbox:checked').length > 0) {
//         $('#delete_selected1').show();
//     } else {
//         $('#delete_selected1').hide();
//     }
// });
...
// });
// $('#fullscreenPreviewModal_2').on('hidden.bs.modal', function () {
//   // Ensure the upload document modal scroll is enabled after closing the fullscreen modal
//     $('#additional_modal').css('overflow-y', 'auto');
// });

// $('#fullscreenPreviewModal1').on('hidden.bs.modal', function () {
//   // Ensure the upload document modal scroll is enabled after closing the fullscreen modal
//   $('#upload_document_modal_1').css('overflow-y', 'auto');
// });

// // Optionally, you can also reset the scroll position
// $('#fullscreenPreviewModal, #fullscreenPreviewModal').on('hidden.bs.modal', function () {
//   $('#upload_document_modal .modal-body').scrollTop(0);
// });

// $('#fullscreenPreviewModal').on('hidden.bs.modal', function () {
//   $('#upload_document_modal_1 .modal-body').scrollTop(0);
// });
...
$(document).on('click', '.upload_document_delete, .upload_form_delete, .upload_additional_document_delete', function(event) {
    event.preventDefault();

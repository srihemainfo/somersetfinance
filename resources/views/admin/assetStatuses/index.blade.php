...
@can('asset_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-outline-success" href="{{ route('admin.asset-statuses.create') }}">
                        ...
                        <tr data-entry-id="{{ $assetStatus->id }}">
                            ...
                            <td>
                                @can('asset_status_show')
                                    <a class="btn btn-xs btn-outline-primary" href="{{ route('admin.asset-statuses.show', $assetStatus->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-group mb-2">
                                    <input type="text" name='term_year' id ='term_year' value="{{  ($isEditable && $enquiry->term_year) ? ($enquiry->term_year  ?? '') : ''}}"  class="form-control" oninput="validateInput(this)">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-2">
                                    <input type="text" name='term_month' id ='term_month' value="{{  ($isEditable && $enquiry->term_month) ? ($enquiry->term_month  ?? '') : ''}}" class="form-control" oninput="validateInput(this)">
                                    <div class="input-group-prepend">
...
<div class="card"  id="introducer_form" style="{{ ($isEditable && $enquiry->application_made == 'Personal Name' && $enquiry->mortgage_status == 'no'  ) ?  'display:block' : 'display:none' }}">
    <div class="card-header">
    ...
    <div class="card" id="introducer_company_form"  style="{{ ($isEditable && $enquiry->application_made != 'Personal Name' && $enquiry->mortgage_status == 'no'  ) ?  'display:block' : 'display:none' }}">
     ...
     <div class="card-footer text-right" id='button_hide'>
            ...
            <button type="button" class="btn btn-success" id="submit"> @if($isEditable && $roleTitle == 1) Move to Case Create @elseif($isEditable && $roleTitle != 1) Updated Case @else Create Case   @endif  </button>
        </div>
...
$(document).ready(function(){
    ...
    //          var formData = $('#enquiry_list').serialize();
    //          var additionalData = { id: '{{ $isEditable && $enquiry->id ?? ''}}'};
    ...
    $('#submit').click(function(e) {
        ...
        if (selectedRole === 'broker') {
            ...
            if ($('#application_made').val() === 'Personal Name') {
                ...
                var companyFieldArray = ['loan_category_type2', 'company_name', 'company_no', 'company_address_1', 'company_client_first_name', 'company_client_phone', 'company_client_email', 'company_client_loan_amount'];

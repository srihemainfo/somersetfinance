...
<form id="enquiry_list" >
        ...
        <div class="card" id="choose_your_div">
            <div class="card-header">
                <p class="m-0">Choose Your Type</p>
            </div>
        ...
        <div class="card" id="broker_form" style="{{  $isEditable &&  $enquiry->loan_category == 'broker' ? 'display:block;' : 'display:none;' }}">
            <div class="card-header">
                <p class="m-0">Answer the few Questions</p>
            </div>
            <div class="card-body">
    ...
    <div class="card-header">
        <p class="m-0">Loan Requirements</p>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <label>Does the customer or family members live or intend to live in 40% or more of the property?</label>
...
<div class="card"  id="introducer_form" style="{{ ($isEditable && (($enquiry->application_made == 'Personal Name' && $enquiry->mortgage_status == 'no') || ($enquiry->loan_category == 'introducer')) ) ?  'display:block' : 'display:none' }}">
    <div class="card-header">
        <p class="m-0">Please Provide Contact Details for Your Customer</p>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="loan_type">Customer First Name</label>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="loan_type">Customer Last Name</label>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="loan_type">Customer Mobile Phone</label>
                        <input type="text" name='client_phone' id="client_phone"  value="{{ ( $isEditable &&  $enquiry->client_phone) ? ($enquiry->client_phone ?? '' ) : ''}}" class="form-control" placeholder="Enter Mobile Phone" oninput="validateInput(this)">
                         <span class="error-message">This field is required.</span>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="loan_type">Customer Email Address</label>
    ...
    <div class="card" id="introducer_company_form"  style="{{ ($isEditable && $enquiry->application_made != 'Personal Name' && $enquiry->mortgage_status == 'no'  ) ?  'display:block' : 'display:none' }}">
            <div class="card-header">
                <p class="m-0">Please Provide Company and Customer Details</p>
            </div>
            <div class="card-body">
                <!--  -->
            ...
            <div class="row">
                ...
                <!-- applicant  details start-->
                 <p class="m-0">Applicant Details</p>
                <hr>
              <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="company_client_first_name">Customer First Name</label>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="company_client_last_name">Customer Last Name</label>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="company_client_phone">Customer Mobile Phone</label>
                        <input type="text" name='company_client_phone' id="company_client_phone" value="{{  ($isEditable && $enquiry->client_phone ) ? ($enquiry->client_phone ?? '' ) : '' }}" class="form-control" placeholder="Enter Mobile Phone" oninput="validateInput(this)">
                         <span class="error-message">This field is required.</span>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="company_client_email">Customer Email Address</label>
                   ...
                   <p class="m-0">Security Details</p>
                        <hr>
                    ...
                    <div class="row">
                       ...
                       <?php /*
                        ...
                        <div class="row security-details">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="company_security_phone">Security Mobile Phone</label>
                                    <input type="text" name="company_security_phone[]" value ="{{$client->phone ?? ''}}" class="form-control company_security_phone" placeholder="Enter Mobile Phone" oninput="validateInput(this)">
                                    <span class="error-message">This field is required.</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row security-details">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="company_security_phone">Security Mobile Phone</label>
                                    <input type="text" name="company_security_phone[]" class="form-control company_security_phone" placeholder="Enter Mobile Phone" oninput="validateInput(this)">
                                    <span class="error-message">This field is required.</span>
                                </div>
                            </div>
                            <div class="col-sm-4">

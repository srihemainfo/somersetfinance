<aside class="main-sidebar" style="min-height: 917px; background-color: #0f5381;">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.model.index') }}"
                    class="nav-link {{ request()->is('admin/model') || request()->is('admin/model*') ? 'active' : '' }}">
                    <i class="fas nav-icon fa-chalkboard-teacher">
                    </i>
                    <p>
                        Model
        ...
        @endcan
        <li class="nav-item">
            <a href="{{ route('admin.sellvehicle.index') }}"
                class="nav-link {{ request()->is('admin/sellvehicle') || request()->is('admin/sellvehicle*') ? 'active' : '' }}">
                <i class="fas nav-icon fa-chalkboard-teacher">
                </i>
                <p>
                     Vehicle list

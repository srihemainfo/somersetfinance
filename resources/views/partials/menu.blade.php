    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @can('tools_access')
                <li
                    class="nav-item has-treeview {{ request()->is('admin/loanType*') ? 'menu-open' : '' }}  {{ request()->is('admin/document_type*') ? 'menu-open' : '' }}  ">
                    <a class="nav-link nav-dropdown-toggle {{ request()->is('admin/loanType*') ? 'active' : '' }} {{ request()->is('admin/document_type*') ? 'menu-open' : '' }}  "
                        href="#">
                    ...
                    @can('loan_type_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.loanType.index') }}"
                                        ...
                                        <i class="fas nav-icon fa-folder-open">
                                        </i>
                                        <p>
                                            Loan Type Create
                                        </p>
                ...
                @can('tools_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('admin/brand*') ? 'menu-open' : '' }} {{ request()->is('admin/model*') ? 'menu-open' : '' }} ">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is('admin/brand*') ? 'active' : '' }} {{ request()->is('admin/model*') ? 'active' : '' }}"
                            href="#">
            ...
            @endcan
                ...
                @can('student_image_upload_access')
                    <li class="nav-item">
                        <a href="{{ route('admin.student-image.index') }}"
                            ...
                            <i class="fas nav-icon fa-user-graduate">
                            </i>
                            <p>
                                Student Images
                            </p>
                ...
                @can('student_edge_access')
                    <li class="nav-item">
                        <a href="{{ route('admin.student-edge.index') }}"
                            class="nav-link {{ request()->is('admin/student-edge/index') || request()->is('admin/students-edge/*') || request()->is('admin/student-personal-attendance/report') || request()->is('admin/student-cat-mark*') ? 'active' : '' }}">
                            <i class="fa-fw nav-icon fas fa-id-card-alt">
                ...
                @can('coe_access')
                    ...
                    <li
                        ...
                        @endcan
                        @can('lab_mark_access')
                            <ul class="nav nav-treeview" style="color:#a7a3a3">
                                <li
                        ...
                        @can('end_exam_access')
                            <ul class="nav nav-treeview" style="color:#a7a3a3">
                                <li
                                    class="nav-item has-treeview {{ request()->is('admin/exam-enrollment*') || request()->is('admin/exam-fee*') || request()->is('admin/exam-result-publish*') || request()->is('admin/exam-registration*') || request()->is('admin/result-publish*') ? 'menu-open' : '' }}">
                                    <a class="nav-link nav-dropdown-toggle {{ request()->is('admin/exam-enrollment*') || request()->is('admin/exam-fee*') || request()->is('admin/exam-result-publish*') || request()->is('admin/exam-registration*') || request()->is('admin/result-publish*') ? 'active' : '' }}"
                                        href="#">
                ...
                @can('academy_activity_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('admin/Faculty-WorkLoad*') ||request()->is('admin/class-time-table*') ||request()->is('admin/staff-lesson-plan*') ||request()->is('admin/Lesson-Plane-Report*') ||request()->is('admin/student-leave-requests*') ||request()->is('admin/student-att-modification*') ||request()->is('admin/bulk-ods*') ||request()->is('admin/staff-subjects/lesson-plan/hod*') ||request()->is('admin/student-Promotion*') ||request()->is('admin/student-attendance-summary*') ||request()->is('admin/subject-attendance-report*') ||request()->is('admin/Syllabus-Completion*') ||request()->is('admin/Staff-Alteration-Report*') ||request()->is('admin/class-attendance-report*') ||request()->is('admin/weekly-class-report*') ||request()->is('admin/absentees-summary-report*') ||request()->is('admin/certificate-provision*') ||request()->is('admin/student-apply-certificate*') ||request()->is('admin/faculty_staff-edge') ||request()->is('admin/faculty_staff-edge/*') ||request()->is('admin/faculty_time_table/*')? 'menu-open': '' }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is('admin/Faculty-WorkLoad*') ||request()->is('admin/class-time-table*') ||request()->is('admin/staff-lesson-plan*') ||request()->is('admin/Lesson-Plane-Report*') ||request()->is('admin/student-leave-requests*') ||request()->is('admin/student-att-modification*') ||request()->is('admin/bulk-ods*') ||request()->is('admin/staff-subjects/lesson-plan/hod*') ||request()->is('admin/student-Promotion*') ||request()->is('admin/student-attendance-summary*') ||request()->is('admin/Syllabus-Completion*') ||request()->is('admin/subject-attendance-report*') ||request()->is('admin/Staff-Alteration-Report*') ||request()->is('admin/class-attendance-report*') ||request()->is('admin/weekly-class-report*') ||request()->is('admin/absentees-summary-report*') ||request()->is('admin/certificate-provision*') ||request()->is('admin/student-apply-certificate*') ||request()->is('admin/faculty_staff-edge') ||request()->is('admin/faculty_staff-edge/*') ||request()->is('admin/faculty_time_table/*')? 'active': '' }}"
                            href="#">
                ...
                @can('fee_management_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('admin/fee-management*') || request()->is('admin/fee-structure*') || request()->is('admin/collect-fee*') || request()->is('admin/fee*') ? 'menu-open' : '' }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is('admin/fee-management*') || request()->is('admin/fee-structure*') || request()->is('admin/collect-fee*') || request()->is('admin/fee*') ? 'active' : '' }}"
                            href="#">
                        ...
                        <ul class="nav nav-treeview" style=" color:#ffffff">
                            ...
                            @endcan
                            @can('collect_fee_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.collect-fee.collectIndex') }}"
                                        class="nav-link {{ request()->is('admin/collect-fee*') ? 'active' : '' }}">

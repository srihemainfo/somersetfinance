                    ...
                    <form method="POST" action="{{ route('twoFactor.check') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a class="btn btn-secondary-danger px-4" href="{{ route('twoFactor.resend') }}">{{ __('global.two_factor.resend') }}</a>
                                <a class="btn btn-outline-danger px-4" href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
                                    {{ trans('global.logout') }}
                                </a>
                            </div>
                        </div>

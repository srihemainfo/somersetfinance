...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown notifications-menu">
                    <a href="#" class="nav-link nav_prof_label" data-toggle="dropdown"
                        style="color:white;display:block;background-color:#0d5181;">
                        ...
                        @if ($data = App\Models\ExamCellCoordinator::where(['user_name_id' => auth()->user()->id])->first())
                            <li
                                ...
                                <ul class="nav nav-treeview"
                                    style="background-color: rgba(100, 100, 100, 0.473); color:#a7a3a3">
                                    <li
                                        class="nav-item has-treeview {{ request()->is('admin/assignment/*') ? 'menu-open' : '' }}">

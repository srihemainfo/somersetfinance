...
class LatestEventController extends Controller
{
    ...
    $SellVehicleDetails->update(['ref_id' => $ref_id]);
        ...
        return redirect()->route('admin.sellvehicle.index')->with('success', 'SellVehicle Details has been Added successfully.');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.lastevent.edit_event', compact('alldatas', 'EvetList', 'data3'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // ]);
        return redirect()->route('admin.sellvehicle.index')->with('success', 'SellVehicle Details  has been updated successfully.');
    ...
    public function purchase(Request $request, $id){
        ...
        return view('admin.lastevent.purchase', compact('Event'));

...
class FormUploadController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     if ($request->id == '') {
        //         $count = FormUpload::where(['title' => $request->title])->count();
        //         if ($count > 0) {
        ...
        //     } else {
        //         $count = FormUpload::whereNotIn('id', [$request->id])->where(['title' => $request->title ])->count();
        //         if ($count > 0) {
        //             return response()->json(['status' => false, 'data' => 'Document Type Already Exist.']);
        //         } else {
        ...
        //                     $image = $request->file('file_name');
        //                     $fileExtension = $image->getClientOriginalExtension();
        //                     $fileName = $request->title .  '.' . $fileExtension;
        ...
        //                     $newFileName = $request->title . '.' . $fileExtension;
